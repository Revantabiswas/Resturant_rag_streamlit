    ...
    try:
        for date in selected_dates:
            ...
            if is_available:
                ...
                # Generate AI response if knowledge base is ready (existing code)
                booking_message = f"Group reservation for {group_name}, {event_type} event for {number_of_people} people on {date} at {time_slot}."
...
if page == "Home":
    ...
    # About Section - Modified to align left
    st.markdown("""
    <style>
    .left-align {
        padding-left: 0;
    ...
    with menu_tab1:
        ...
        with col1:
            st.image("https://www.indianhealthyrecipes.com/wp-content/uploads/2021/12/samosa-recipe.jpg", width=100)
        with col2:
        ...
        col1, col2 = st.columns([1, 3])
        with col1:
            st.image("https://www.kitchensanctuary.com/wp-content/uploads/2021/01/Onion-Bhaji-square-FS-23.jpg", width=100)
        with col2:
    ...
    with res_tab2:
        ...
        # Show availability by time slot - using real data
    ...
    with col2:
        ...
        with st.form("contact_form"):
            st.text_input("Name", key="contact_name")  # Adding keys also helps prevent issues
